...
//тут поле объявленно как balance, а также второй balance взят из файла users.js
...
const getNamesSortedByFriendsCount = users => {
  users.sort((firstObj, secondObj) => firstObj.friends.length - secondObj.friends.length)
